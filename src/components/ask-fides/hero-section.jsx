...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden border-b border-[rgba(30,58,138,0.3)] bg-[#0a192f]">
      ...
      <div className="mx-auto flex max-w-[1280px] flex-col items-start gap-10 px-4 py-14 sm:px-6 sm:py-16 lg:flex-row lg:items-center lg:gap-12 lg:px-8 lg:py-24">
        <HeroCopy />
        <HeroVisual />
      </div>
    </section>
